# Node.js : HTTP/2 <img valign="bottom" align="right" height="40px" widht="40px" src="https://nodejs.org/static/images/logos/nodejs-new-pantone-black.png" />


### What is in there
This GitHub repository is just a simple helloworld starter using the native http/2 module.
...
### How to make it run
```
git clone https://github.com/mustapha-benmbarek/nodejs-http2
cd nodejs-http2
```
